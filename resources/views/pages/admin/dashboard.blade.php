...
@section("content")
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset("build/assets/dist/img/AdminLTELogo.png")}}" alt="AdminLTELogo" height="60"
      width="60">
  </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="{{ route('boards.index') }}" class="small-box-footer">More info <i
